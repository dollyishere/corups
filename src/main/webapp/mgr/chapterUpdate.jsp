...
<body>
    ...
    <div align="center" border="1">
        <form action="${contextPath}/chapter/chapterUpdateServlet" method="post">
            ...
            <table align="center" border="1" summary="챕터 수정">
                <tr>
                    <th colspan="2" align="center">${chapter.name} 쳅터 수정</th>
                </tr>
                <tr>
                    <td>챕터 이름 :</td>
                    <td><textarea id="chapterName" name="chapterName" class="ckeditor" rows="4" cols="50"></textarea>
                </tr>
                <tr>
                    <td>시작 날짜 :</td>
    ...
    <script>
        CKEDITOR.replace('chapterName', {
            ...
            shiftEnterMode: CKEDITOR.ENTER_BR  // Shift+Enter로도 <br> 태그 사용
        });
        CKEDITOR.instances['chapterName'].setData('${chapter.name}');
    </script>
</body>
</html>
