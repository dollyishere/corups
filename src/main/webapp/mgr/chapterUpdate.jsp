...
<body>
	...
	<div align="center" border="1">
		<form action="<c:url value='/mgr/chapterUpdateServlet'/>" method="post">
			<table align="center" border="1" summary="챕터 수정">
				...
				<tr>
					<td>챕터 이름 :</td>
					<td><input type="text" name="chapterName" value="chaptername${chapter.name}" /></td>
				</tr>
				<tr>
					<td>시작 날짜 :</td>
				...
				<tr>
					<td colspan="2" align="center">
						...
						<input type="button" name="deleteChpater" value="삭제"
							onclick="location.href='<c:url value='/mgr/chapterDeleteServlet'/>'" />
